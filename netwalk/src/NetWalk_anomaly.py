...
from framework.forest import get_forest
...
def static_process(args):
    ...
    #here, we need to create hashes from the clique embedding and implement LSHiForest
    forest = get_forest(embedding, train, k)
    ...
    auc, ab_score = anomaly_detection(embedding, train, synthetic_test[0:args.snap, :], k, forest)
    ...
    while(netwalk.hasNext()):
        ...
        auc, ab_score = anomaly_detection_stream(embedding, train, test_piece, k, alfa, forest)
